  ...
  return (
    <>
      <div className="relative w-full h-[648px]">
        <Image src="/portda.jpg" fill alt="portada" className="w-full h-full object-cover" />
        ...
        <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black to-transparent text-white px-[96px] py-8">
          <div>
            ...
            <p className="text-lg text-gray-300 mt-2">9 Episodes • 2022 • Fantasy • Actions</p>
          </div>
      ...
      <div className="bg-white text-[16px] text-black pt-[42px] pb-[24px] px-[72px] flex-nowrap">
        <p>
          The Last of Us is an American post-apocalyptic drama television series created by Craig Mazin and Neil
          Druckmann for HBO. Based on the 2013 video game developed by Naughty Dog, the series is set in 2023, twenty
          years into a pandemic caused by a mass fungal infection, which causes its hosts to transform into zombie-like
          creatures and collapses society. The series follows Joel (Pedro Pascal), a smuggler tasked with escorting the
          immune teenager Ellie (Bella Ramsey) across a post-apocalyptic United States...
